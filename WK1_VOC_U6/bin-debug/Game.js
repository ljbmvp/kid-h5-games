...
var Game = (function (_super) {
        ...
        if (cardView.cardName == self.m_curQuestion.name) {
            ...
            cardView.right(function () {
                ...
                if (self.m_rightCount >= Game.WIN_NUM) {
                    ...
                    self.m_effSound.playSync("U6VOC04_mp3", function () {
                        self.m_role1.state = RoleState.celebrate_speak;
                        self.m_effSound.playSync("U6VOC-OS01_mp3", function () {
                            self.m_effSound.playSync("U6VOC-OS02_mp3", function () {
                                self.m_role1.state = RoleState.celebrate;
            ...
            egret.setTimeout(function () {
                ...
                cardView.boom(); //爆炸
                //答错音效
                self.m_effSound.playSync("U6VOC03_mp3", function () {
                    if (self.m_failCount >= Game.FAIL_NUM) {
                        //游戏失败
                        _this.m_thunderSound = new SoundPlayer();
                        _this.m_thunderSound.playSync("U6VOC05_mp3"); //打雷音效
                        _this.m_gameScene.snow(); //下雪
                        self.m_role1.state = RoleState.sad_mouth;
                        self.m_effSound.playSync("U6VOC-OS03_mp3", function () {
                            self.m_role1.state = RoleState.fail;
                            self.m_effSound.playSync("U6VOC06_mp3", function () {
                                self.m_effSound.playSync("U6VOC-OS04_mp3", function () {
    ...
    Object.defineProperty(Game.prototype, "screenLayer", {
        get: function () { return this.m_screenLayer; },
        enumerable: true,
        configurable: true
    });
